#!/usr/bin/env python3
"""
Automatic MCP Server Runner

Runs the fully automatic AI Validation MCP server.
"""
...
def main():
    ...
    # Path to the automatic MCP server script
    mcp_server_script = os.path.join(script_dir, "ai_validation_mcp_auto.py")
